...
next_clip_id: "part-4-07-git-teacher"
---

# Part 4 / Clip 6: skillers-suda — 4명 전문가와 스킬 설계

> 세션: Part 4 / Clip 6 (~30분)
...
→ **[Part 4 / Clip 7: 바르다 깃선생 — git/GitHub 첫 발](#part-4-07-git-teacher)** — Part 4 마지막은 git/GitHub 첫 발을 떼는 자리예요. Part 5에서 워크스페이스를 받기 시작하는데, 그 받는 방법이 보통 `git clone`이거든요. 한 번 익혀두고 가면 매끄러워요.

오늘 만든 `.claude/skills/{내스킬명}/SKILL.md`도 깃선생 클립에서 첫 push 대상으로 써볼 수 있습니다. 강의용 예제가 아니라 내 도구로 바뀌는 순간이 여기서 시작돼요.

...
next_clip_id: "part-6-01-context-management"
---

# Part 5 / Clip 4: 메모리와 스킬 자가성장

> 세션: Part 5 / Clip 4 (~28분)
...
→ **[Part 6 / Clip 1: 컨텍스트 관리](#part-6-01-context-management)** — 다음 Part부터는 클로드코드를 더 깊이 다룹니다. 먼저 길어진 대화를 `/clear`·`/compact`·`/rewind`로 갈무리하는 법부터 시작해요.

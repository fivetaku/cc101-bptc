...
> 📁 **실습 자료 폴더 — [Google Drive에서 받기](https://drive.google.com/file/d/1RWj6TULCJ6JKAmH2AKOD0aPJZeQuBrcx/view?usp=drive_link)**
>
> 받은 폴더를 본인 컴퓨터의 `~/Downloads/cc-demo`에 풀어두면 정리 대상이 바로 준비됩니다. 개인 파일이 섞인 다운로드 폴더로 실습하기 부담스러우면 이 자료로 진행하세요.

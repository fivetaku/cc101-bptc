...
```text
~/Desktop/bptc-cc/30-templates/portfolio-template/ 안의 자료(00-포트폴리오-리서치.md + images/)를 ~/Desktop/bptc-cc/50-my-work/Part03-체험하기/실습11-포트폴리오기획/ 폴더로 복사해 주세요. 이전 Clip 5~7 결과물은 가져오지 마세요. 그 다음 작업 폴더로 진입해서 Clip 8 시작 준비됐는지 알려주세요.
```

→ 클로드코드가 자동으로 폴더 생성 + 자료 복사 + 진입까지 처리합니다.
